...
class DataTransaksi {
private:
    string tabel[100][4];  // kolom : 0=nama, 1=jenis layanan, 2=berat, 3=total bayar
    int jumlah;
...
private:
    int matriks[100][3];  // kolom : Hari ke-1, Hari ke-2, Hari ke-3 (1 = masih proses, 0 = sudah lewat/selesai)
    int jumlah;
